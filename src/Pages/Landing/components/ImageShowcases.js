            ...
            <div className="container-fluid p-0">
                <div className="row no-gutters">
                    ...
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
                        ...
                        <p className="lead mb-0">Faça uma simulação de investimento contínuo no seu fundo de investimento favorito. Selecione o FII, o valor dos aportes e sua periodicidade, e você verá o resultado de seu retorno.</p>
                    </div>
                </div>
                <div className="row no-gutters">
                    ...
                    <div className="col-lg-6 my-auto showcase-text">
                        ...
                        <p className="lead mb-0">Os dados são representados principalmente por meio visual. Aqui você encontrará gráficos de fácil interpretação que mostrarão como está a situação do fundo imobiliário que você analisa.</p>
                    </div>
                </div>
                <div className="row no-gutters">
