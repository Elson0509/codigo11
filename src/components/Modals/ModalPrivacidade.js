        ...
        <span className="d-inline-block mb-2 mr-2">
            <Modal isOpen={props.modal} toggle={props.toggle}>
                <ModalHeader toggle={props.toggle}>Termos e condições de uso</ModalHeader>
                        <ModalBody>
                            <div className="term">
                                <p>A sua privacidade é importante para nós. É política do Codigo11 respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Codigo11, e outros sites que possuímos e operamos.</p>
                                ...
                                <h2>Política de Cookies Codigo11</h2>
                                ...
                                <p>Esta política é efetiva a partir de <strong>Maio</strong>/<strong>2020</strong>.</p>
                            </div>
                        </ModalBody>
                        <ModalFooter>
