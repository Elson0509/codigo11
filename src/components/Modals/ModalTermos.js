    ...
    return (
        <span className="d-inline-block mb-2 mr-2">
            <Modal isOpen={props.modal} toggle={props.toggle}>
                <ModalHeader toggle={props.toggle}>Termos e condições de uso</ModalHeader>
                        <ModalBody>
                            <div className="term">
                                <p>VISÃO GERAL</p>

                                <p>Esse site é operado pelo Codigo11. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Codigo11. O Codigo11 proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.</p>
                                ...
                                <p>SEÇÃO 6 - FERRAMENTAS OPCIONAIS</p>
                                ...
                                <p> SEÇÃO 7 - LINKS DE TERCEIROS</p>
                                ...
                                <p> SEÇÃO 8 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO</p>
                                ...
                                <p> SEÇÃO 9 - INFORMAÇÕES PESSOAIS</p>

                                <p>O envio de suas informações pessoais é regido pela nossa Política de privacidade. Ver nossa Política de privacidade.</p>

                                <p> SEÇÃO 10 - ERROS, IMPRECISÕES E OMISSÕES</p>

                                <p>Ocasionalmente, pode haver informações no nosso site ou no Serviço que contém erros tipográficos, imprecisões ou omissões. Reservamos o direito de corrigir quaisquer erros, imprecisões ou omissões, e de alterar ou atualizar informações caso qualquer informação no Serviço ou em qualquer site relacionado seja imprecisa, a qualquer momento e sem aviso prévio.</p>

                                <p>Não assumimos nenhuma obrigação de atualizar, alterar ou esclarecer informações no Serviço ou em qualquer site relacionado, exceto conforme exigido por lei. Nenhuma atualização específica ou data de atualização no Serviço ou em qualquer site relacionado, deve ser utilizada para indicar que todas as informações do Serviço ou em qualquer site relacionado tenham sido modificadas ou atualizadas.</p>

                                <p>SEÇÃO 11 - USOS PROIBIDOS</p>
                                ...
                                <p> SEÇÃO 12 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</p>
                                ...
                                <p>Se em nosso critério exclusivo você não cumprir com qualquer termo ou disposição destes Termos de serviço, nós também podemos rescindir este contrato a qualquer momento sem aviso prévio. Também podemos lhe negar acesso a nossos Serviços (ou qualquer parte deles).</p>

                                <p> SEÇÃO 16 - ACORDO INTEGRAL</p>
                                ...
                                <p>SEÇÃO 17 - ALTERAÇÕES DOS TERMOS DE SERVIÇO</p>
